...
module VgaDebugger(
    ...
    always @* begin
        case (display_addr)
            ...
            1288: begin dynamic_hex = IdEx_is_imm[2:0]; display_wen = 1; end
            ...
            1369: begin dynamic_hex = IdEx_mem_wen[3:0]; display_wen = 1; end
            1382: begin dynamic_hex = IdEx_mem_ren[3:0]; display_wen = 1; end
            ...
            1769: begin dynamic_hex = ExMa_mem_wen[3:0]; display_wen = 1; end
            1782: begin dynamic_hex = ExMa_mem_ren[3:0]; display_wen = 1; end
