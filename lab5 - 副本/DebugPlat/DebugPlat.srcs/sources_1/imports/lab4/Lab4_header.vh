...
/* Trap */
// mtvec's base address
`define BASE_ADDR 30'h0000008E
// mcause's exception code
`define MCAUSE_NONE 31'h7FFFFFFF
`define MCAUSE_INT 31'h00000000
`define MCAUSE_ECALL 31'h00000001
`define MCAUSE_ILLEGAL_INST 31'h00000002

/* Full Inst */
`define INST_WIDTH 32
`define INST_ECALL `INST_WIDTH'h00000073
`define INST_MRET  `INST_WIDTH'h30200073
...
`define MEM2REG_IMM         `MEM2REG_WIDTH'd3
/*-----------------------------------*/
